...
const Navbar = () => {
    ...
    <li className="text-[18px]"><NavLink className={({isActive }) => isActive ? 'text-[#46f555] font-bold border border-[#46f555]' : 'font-bold text-black'} to='/page'>Pages to Read </NavLink></li>
