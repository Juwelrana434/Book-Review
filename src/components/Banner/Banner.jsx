...
const Banner = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <div>
      <h1 className="text-[56px] font-bold lin leading-[84px]">Books to Freshen up <br />your bookshelf</h1>
      <button className="bg-[#23BE0A] mt-10 p-4 text-white font-bold rounded-lg">View the List</button>
    </div>
  </div>
</div>
        </div>
